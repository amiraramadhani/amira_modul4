    ...
    <nav class="navbar fixed-top navbar-expand-lg bg-purple" data-bs-theme="dark">
        ...
        <div class="container py-2 px-4">
            ...
            <a href="#" class="navbar-brand mb-0 h1">
                <img class="img-fluid" src="<?php echo e(asset('images/logo-white.svg')); ?>" alt="logo" style="width: 40px" />
            </a>
            <!-- Navbar Toggler -->
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-md-5 order-md-2">
                    <img class="img-fluid" src="<?php echo e(asset('images/main.svg')); ?>" alt="main logo" />
                </div>
                <div class="col-md-7 order-md-1">
                    ...
                    <div class="row">
                        <div class="d-flex flex-column flex-md-row">
                            ...
                            <button type="button" class="btn btn-outline-dark btn-lg mb-3 px-4 py-3">
                                Download
                            </button>
                        </div>
                    </div>
    ...
    <div id="bs-icons">
        <div class="container py-5 px-4">
            <div class="row">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="<?php echo e(asset('images/bs-icons.png')); ?>" alt="Bootstrap Icons" />
                </div>
            </div>
        </div>
    </div>
        ...
        <div class="container py-5 px-4">
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <h2 class="display-5">
                        Make it yours with official BootstrapThemes
                    </h2>
                    <p class="fs-5">
                ...
                <div class="col-lg-6">
                    <img class="img-fluid" src="<?php echo e(asset('images/bs-themes.png')); ?>" alt="Bootstrap Themes" />
                </div>
            </div>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-3 mb-5">
                    <a href="#" class="logo text-decoration-none">
                        <div class="d-flex">
                            <img class="img-fluid" src="<?php echo e(asset('images/logo-black.svg')); ?>" alt="Bootstrap Logo"
                                style="width: 40px" />
...
<?php /**PATH C:\xampp2\htdocs\modul4-\laravel\resources\views/boostrap.blade.php ENDPATH**/ ?>